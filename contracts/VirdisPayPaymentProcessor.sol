...
contract VirdisPayPaymentProcessor is ReentrancyGuard, Pausable, Ownable {
    ...
    uint256 public platformFeePercentage = 250; // 2.5% in basis points (default for free tier)
    ...
    constructor(address _treasury) {
        ...
        authorizedTokens[0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174] = true; // USDC on Polygon
        authorizedTokens[0xc2132D05D31c914a87C6611C10748AEb04B58e8F] = true; // USDT on Polygon
    }

    /**
     * @dev Set platform fee percentage (only owner)
     * @param _feePercentage Fee in basis points (e.g., 250 = 2.5%)
     */
